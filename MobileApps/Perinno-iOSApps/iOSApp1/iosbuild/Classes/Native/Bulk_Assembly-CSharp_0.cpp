...
extern String_t* _stringLiteral26539934;
...
extern "C"  void ExplodeOnTap_Update_m4134223795 (ExplodeOnTap_t36386905 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		Object_t631007953 * L_2 = Resources_Load_m3880010804(NULL /*static, unused*/, _stringLiteral3139706531, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(Object_t631007953_il2cpp_TypeInfo_var);
		Object_t631007953 * L_3 = Object_Instantiate_m3403600534(NULL /*static, unused*/, L_2, /*hidden argument*/NULL);
		NullCheck(L_1);
		Animator_set_runtimeAnimatorController_m3324432892(L_1, ((RuntimeAnimatorController_t2933699135 *)IsInstClass((RuntimeObject*)L_3, RuntimeAnimatorController_t2933699135_il2cpp_TypeInfo_var)), /*hidden argument*/NULL);
	}
...
IL_0028:
	{
		GameObject_t1113636619 * L_4 = GameObject_Find_m2032535176(NULL /*static, unused*/, _stringLiteral26539934, /*hidden argument*/NULL);
		__this->set_go_4(L_4);
		return;
	}
}
...
extern "C"  void RemoveTurbineOnAnchor_Update_m1382202391 (RemoveTurbineOnAnchor_t3219848557 * __this, const RuntimeMethod* method)
{
	...
	{
		bool L_0 = __this->get_destroyGO_3();
		if (!L_0)
		{
			goto IL_0033;
		}
	...
	{
		GameObject_t1113636619 * L_1 = __this->get_go_4();
		IL2CPP_RUNTIME_CLASS_INIT(Object_t631007953_il2cpp_TypeInfo_var);
	...
	{
		GameObject_t1113636619 * L_3 = __this->get_go_4();
		NullCheck(L_3);
		GameObject_SetActive_m796801857(L_3, (bool)0, /*hidden argument*/NULL);
		GameObject_t1113636619 * L_4 = __this->get_go_4();
		IL2CPP_RUNTIME_CLASS_INIT(Object_t631007953_il2cpp_TypeInfo_var);
