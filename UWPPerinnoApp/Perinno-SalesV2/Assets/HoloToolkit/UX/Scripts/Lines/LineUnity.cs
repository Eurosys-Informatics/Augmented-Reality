...
namespace HoloToolkit.Unity.UX
{
    ...
    {
        const string DefaultLineShader = "Standard";
        ...
        protected void OnEnable()
        {
            ...
            if (LineMaterial == null)
            {
                ...
                //LineMaterial = Resources.Load<Material>("Material/MRTK_Standard_Blue");
                Debug.Log("Line material" + LineMaterial.color);
                LineMaterial.SetColor(DefaultLineShaderColor, Color.blue);
            }
