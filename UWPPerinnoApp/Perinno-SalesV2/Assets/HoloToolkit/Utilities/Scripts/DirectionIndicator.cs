...
namespace HoloToolkit.Unity
{
    ...
    public class DirectionIndicator : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            txtGO = GameObject.Find("DirectionIndicatorText");
            txt = GameObject.Find("DirectionIndicatorText/text").GetComponent<TextMeshPro>();
        ...
        public void Update()
        {
            ...
            //Debug.Log("INFO: Obj position:" + gameObject.transform.position);
            //Debug.Log("INFO: Cam to Obj Direction:" + camToObjectDirection);
            ...
            txtGO.SetActive(isDirectionIndicatorVisible);
            ...
            if (isDirectionIndicatorVisible)
            {
                ...
                txt.transform.position = position + new Vector3(0.15f,-0.075f,0);
                txt.transform.rotation = rotation * Quaternion.Euler(180.0f,0,0.0f);
                Vector3 angles = txt.transform.rotation.eulerAngles;
                txt.transform.rotation = Quaternion.Euler(angles.x, angles.y, 0.0f);
            }
        }
